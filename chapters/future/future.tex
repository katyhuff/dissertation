...
A repsitory model, integrated in the \Cyclus fuel cycle simulation platform, 
...
In order to do so, liquids will be ddefined by their dynamic viscosities ($\mu$, 
[Pascal seconds]),
...
and the \gls{ANDRA} and RED-IMPACT ssessments.
...
\begin{minipage}[b]{0.5\linewidth}
  ...
  \end{center}
  \caption{The control volume contains an intact waste form matrix 
...
\subsubsection{Extension Abstraction}
  ...
  Similar abstraction analysis will be undertaken for the phenomena involed in 
  ...
  previous phases, but will focus on one extending feature at a time. 

...
The capability to allow each component to define the components within it gives this 
repository the ability to model many types of repository concept 
while maintaining a simple interface with the simulation. <+EXPOUND+> 

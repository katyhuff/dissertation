...
model  a rate based model which takes place within the waste package 
...
In the Hedin model of the Swedish KBS repository, waste matrix 
...
with the buffer-geosphere interface. 
...
fuel cycle simulator \cite{VISION} and recent efforts on the NUWASTE simulator 
\cite{NUWASTE} have made some progress in addressing this deficiency, but many 

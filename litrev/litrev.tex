...
Modules within GoldSim represent components of the waste disposal 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Analytical Models of Nuclide Transport} 
...
\section{Waste Form Release Models}

\subsection{Hedin Model (\cite{hedin_integrated_2002})}
...
\subsection{Ahn Models (\cite{ahn_environmental_2004, 
...
\subsection{Congruent Release Model} 
...
\subsection{Solubility Limited Release Model}
...
\section{Waste Package Failure Models}
...
\section{Nuclide Transport Through Engineered Barriers}

\subsection{Barrier Dissolution and Failure}

\subsection{Transport Through EBS Matrix}


%%%%

\section{Hydrogeologic Transport Models}

\subsection{Solute Transport in Permeable Porous Media}
...
\subsection{Solute Transport in Fractured Media}
...
Zhang, in terms of the cross subsubsectional contact areas of the matrix and 
...
model. %(pg198 for references to the math)

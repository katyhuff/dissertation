...
% Things to ask about each of them include: % Which geologies do they model?  
% How long do they take to run?  Are they proprietary?  How well 
% validated are they?  
% Do they include any notion of repository capacity, dose, heat?  
% Are they capable of dealing with waste of varying compositions?  
% Are therewasteform models?  
...
very different under dry oxidising conditions, %almost no corrosion aqueous
oxidising conditions, %which means a steel corrosion rate (concentrated at the
cell head) of %several tens of microns per year. This phase is very limited in
...
% water in the rock, i.e. about 9 
%, corresponding to half the total 
...
\cite{andra_argile:_2005} %page 197 
...
\begin{equation} w_{ci}(t)=C_i(t)q_{out}(t) \end{equation}

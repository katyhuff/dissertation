...
\subsubsection{Clay/Shale GDSE Model}
...
\begin{align}
  ...
  \intertext{and}
  K_d &= \mbox{distribution coefficient of the species in the rock.}
\end{align}
...
\begin{align*}
  C(\vec{r},t) = C_0(\vec{r},t)\mbox{for} r \in \Gamma\\
  \frac{\partial C(\vec{r},t)}{\partial x} = nD\vec{J} \mbox{for} \vec{r} \in \Gamma
\end{align*}
...
enough to account for real 
fracturation\cite{berkowitz_continuum_1988}\cite{anderson_applied_1992}.

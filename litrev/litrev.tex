...
concept is almost exactly similar to these, except emplacement is horizontal 
within the horizontal repository drifts.  

Finland china south korea switzerland. ??
UFD
...
granite hydraulic conductivity is low, typically found between <+lowK+> and 
<+highK+> \cite{schwartz_fundamentals_2004, x }. Within this environment, the  
...
salinity, resulting in decreased solubilities, <+(and higher sorption???)+> \cite{x}
...
alkaline, resulting in increased breakdown of <+some materials+>.

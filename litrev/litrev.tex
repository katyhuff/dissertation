...
bedded salt formation in a reducing, saturated environment. Once waste packages  
are horizontally placed in a corner of the alcove, the space is backfilled with 
crushed salt. 
...
and sorption. Specifically, the Finite Element Heat and Mass Transfer code was 
coupled into GoldSim to represent the far field. 

Heat was modeled with the FEHM.  

...
\gls{GDSM}s for various geological environments. Teams from Argonne
...
Thermal modeling for the \gls{GDSM}s are conducted independently with 
...
The Clay \gls{GDSM}s a single waste form, waste package, \gls{EBS}, 

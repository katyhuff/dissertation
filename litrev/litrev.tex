...
concepts are given in Table \ref{tab:clay_tab.tex}.   
...
concepts are given in Table \ref{tab:granite_tab.tex}.   
...
concepts are given in Table \ref{tab:salt_tab.tex}.   
...
neutral in this environment \cite{von_lensa_red-impact, clayton_generic_2011}.
...
concepts are given in Table \ref{tab:borehole_tab.tex}.   

...
being the number of failed waste packages per unit time, $N$ being the total number of waste 
...
\begin{align}
  ...
  &E_A = \mbox{the activation energy of diffusion} [J/kg]\\
...
A one dimensional heat transfer rate can be found by integration over the surface 

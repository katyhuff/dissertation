...
as a single \gls{EBS} unit. Since the thermal mass of the EBS is small in
comparison to the thermal mass of the host rock, the transient state of the
 transient temperature between the host 
rock and the EBS is found with a MathCAD solution of the transient homogeneous 
conduction equation

...
Radionuclide transport through the lithology is dependent upon diffusion as
well as advection. Radionuclide transport is retarded by sorption, limited by 
solubility, and enhanced by colloidal mobility \cite{bracke_safety_2008}. 
...
\begin{align}
  ...
  \label{planck}
  \intertext{where}
  \sigma =5.670373\times 10^{−8} [W/ m^{2}\cdot^{\circ}K^{4}].\nonumber
  \intertext{and}
  F_{1\rightarrow 2} =
  \begin{cases}
    \epsilon_1 &
...
capacitance solver, the \acrlong{SINDAG}.

...
repository lithology, engineered barriers, appropriate loading strategies and
...
potential repository host lithologies to include, at the very least, granite, 
...
repository to bentonite or concrete in other lithologies. Therefore, a repository  
...
Specifically, three candidate lithologies and four corresponding repository 
...
lithologies as a function of radionuclide release and heat generation over long 
...
with available detailed models (e.g. 2D and 3D finite difference, finite 
...
lithologies.  Next, the literature review focuses upon current analytical and 
computational modeling of radionuclide and heat transport through various waste 
forms, engineered barrier systems, and lithologies of interest.  It will also 
address previous efforts in generic geologic environment repository modeling in order to 

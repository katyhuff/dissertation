...
lithologies under consideration domestically and internationally are then also 
...
transport on long time scales and in various lithologies. 
...
chosen to capture the primary lithologies and concepts found in the following review 
...
disposal environment also lowers solubility limits and increases sorption of 
many actinide species. The dominant dose contributors in reducing environments are 
...
environments may be parsed in the event that an extension model simulates an 
...
diffusion dominated water movement and no fracturation result in a very low 
...
Attributes of granite that make it an attractive candidate lithology for nuclear 
...
internationally and domestically. These efforts, the lithologies they address, and  
...
medi. While clay, shale and salt do not exhibit significant fracturation and can 
...
Equivalent Porous Medium (EPM) models assume that a uniformly  fractured medium
...
system and host rock lithology. This model must sufficiently solve for peak temperatures 
...
addressing various repository lithologies and geometries will be reviewed here 
...
\begin{figure}[htbp!]
  \begin{center}
    \includegraphics[height=10cm]{./litrev/sindageom.eps}
  \end{center}
...
seeks to inform heat limited waste capacity calculations for each lithology, for 

  \begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{|X|c|c|X|}
      \multicolumn{4}{c}{\textbf{Radionuclide Transport Models for Various Geologic Media}}\\
      \hline
      ...
      ANDRA \cite{andra_argile:_2005}                   & France      & Argillite               & Very detailed CEA code  \\
      ...
      \hline
    \end{tabularx}
    \caption[International use of radionuclide transport models in various 
    geologic host media.]{Computational methods by which to 

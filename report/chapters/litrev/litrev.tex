...
calculations of fuel cycle metrics. Most current tools treat the waste disposal 
...
Among the more sophisticated fuel cycle tools, a few (e.g.,
\gls{NUWASTE} \cite{abkowitz_nuclear_2010},
\gls{NFCSim} \cite{schneider_nfcsim_2004}, and 
...
% matrix determines the appropriate model with which to treat rock fractures
...
% For details about fracture models in unsaturated rock, it's likely best to 

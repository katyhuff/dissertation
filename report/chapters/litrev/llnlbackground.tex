% LLNL
A semi-analytic model, created at \gls{LLNL} for the \gls{UFD} campaign seeks to 
...
Jaeger \cite{carslaw_conduction_1959} and is implemented in MathCAD 
\cite{ptc_mathcad_2010}.  The integral solver in the MathCAD toolset is the 
primary calculation engine for the semi-analytic MathCAD thermal model, which 
relies on superposition of integral solutions.  
...
Figure \ref{fig:llnl} shows the geometric layout of the semi-analytic \gls{LLNL} model 

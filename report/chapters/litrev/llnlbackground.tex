% LLNL
The semi-analytic model, created at \gls{LLNL} for the \gls{UFD} campaign seeks to 
...
\gls{EBS} within the disposal tunnel wall. The first region is taken to be  
...
The geometric layout of the semi-analytic \gls{LLNL} model in Figure \ref{fig:llnl} 

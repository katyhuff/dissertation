...
\begin{minipage}[b]{0.45\linewidth}
  ...
  \caption[Case DRII Waste Package Contaminants.]{ 
    Waste Package 6 ($F_d = 0$) achieves total containment.
    }
  \label{fig:drIIwp6}
...
\begin{minipage}[b]{0.45\linewidth}
  ...
  \caption[Case DRIII Buffer Contaminants]{
    The Buffer, component 7 ($F_d=0$), achieves total containment.
    }
  \label{fig:drIIIbuff}
...
\begin{minipage}[b]{0.45\linewidth}
  ...
  \caption[Case DRIV Waste Package Contaminants.]{ 
    All material is released into Far Field, component 0 ($F_D = 0.0$).
    }
  \label{fig:drIVff0}

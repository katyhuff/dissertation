...
\begin{minipage}[b]{0.45\linewidth}
  ...
  \caption[Case LPEMII Waste Package Contaminants.]{ 
    Waste Package 6 ($F_d = 0.0$) acheives total containment. 
    }
  \label{fig:lpEMIIwp6}
...
\begin{minipage}[b]{0.45\linewidth}
  ...
  \caption[Case LPDMII Buffer Contaminants]{
    The Buffer, component 7 ($F_d=0.1$), naver receives material.
    }
...
\begin{minipage}[b]{0.45\linewidth}
  ...
  \caption[Case LPPFMII Waste Package Contaminants.]{ 
    Waste Package 6 ($F_d = 0.1$) acheives total containment. 
    }

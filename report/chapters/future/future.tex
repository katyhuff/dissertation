...
\subsubsection{Base Case Concept}
  ...
  % Concept
    ...
    % uniform unfractured permeable porous medium
      ...
      appropriate for clay and salt geologies. The fracturing in the geologies  
    ...
    % WF : uox 
      ...
      corrosive degradation rate. A graphical representation of the base case 
      waste form dissolution model is given in Figures \ref{fig:intact} 
      and \ref{fig:dissolved}. 

...
parameter models (Figure \ref{fig:lumpedseries}). Based on this lumped parameter 
interpretation, the Lumped Parameter mass balance model implemented a response 

...
semi-infinite boundary condition in the positive flow direction. 
...
A numerical integration is to evaluate the integral of $C(t_n, r)$ in equation 
\eqref{simple_genuchten} by plugging it into equation \eqref{lp_mass}.

...
\begin{align}
  ...
  C(z,t) = \frac{C_0}{2}\Bigg[&\mbox{erfc}\left[{\frac{z-v_zt}{2\sqrt{D_Lt}}}\right] 
  + \frac{1}{2} \left(\frac{v_z^2t}{\pi D_L}\right)^{1/2}e^{\frac{-( z - 
  v_zt)^2}{4D_Lt}}\nonumber\\
  &- \frac{1}{2}\left( 
  1+\frac{v_zL}{D_L}+\frac{v_z^2t}{D_L}\right)e^\frac{v_zz}{D_L}\mbox{erfc}\left[\frac{z-V_zt}{2\sqrt{D_Lt}}\right]
  \Bigg].
\end{align}

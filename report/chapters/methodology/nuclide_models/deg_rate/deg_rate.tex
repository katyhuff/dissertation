...
appropriate for simplistic modeling of a degrading barrier volume. It simulates 
the fractional degradation of the contaminaent containment in the component.  
The fundamental concept is depicted in Figure \ref{fig:deg_volumes}.

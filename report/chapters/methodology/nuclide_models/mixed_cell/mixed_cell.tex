...
\begin{align}
s_{i,ds} &= K_{di} C_{i,df}\nonumber\\
         &= \frac{K_{di}m_{i,df}}{V_{df}}\nonumber
\intertext{where}
\end{align}
...
isotope subscritps and beginning with equation \eqref{c_df} 
and combining this with equation \eqref{linear_iso},

\begin{align}
m_{df} &= \frac{C_{df}}{V_{df}}\nonumber\\
m_{df} &= \frac{m_{ds}V_{df}}{K_dV_{ds}}\nonumber

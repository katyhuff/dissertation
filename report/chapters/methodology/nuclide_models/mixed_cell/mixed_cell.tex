...
Slightly more complex, the mixed cell model incorporates solubility limited, congruent 
...
the cell. This distribution of contaminant mass is restricted, however,
by dissolved concentration (often called solubility) limits
and sorption.  

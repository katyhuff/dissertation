...
\subsubsection{Calculation of Mass Flux}
...
utilize the source term, Dirichlet, Neumann, and Cauchy interfaces, 
respectively.  Once calculated, that material object is removed from the 

\subsection{Mixed Cell Radionuclide Mass Balance Model}\label{sec:mixed_cell}
...
This model distributes contaminant masses throughout each volume. Contaminant 

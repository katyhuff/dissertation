...
at hand is to be implemented. 
The Cyder repository is a subclass of the FacilityModel class, inheriting the 
FacilityModel interface defined in \Cyclus.
Though some FacilityModel subclasses make both requests and offers to the system, the Cyder model is a type 

...
\begin{figure}[htbp!]
\begin{center}
%\includegraphics[width=0.7\textwidth]{./chapters/thermal_sensitivity/diffusivity/Cm242alpha_kth_low.eps}
\end{center}
...
\begin{figure}[htbp!]
\begin{center}
%\includegraphics[width=0.7\textwidth]{./chapters/thermal_sensitivity/diffusivity/Cm242alpha_kth_high.eps}
\end{center}

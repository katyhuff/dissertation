...
\begin{minipage}[b]{0.5\linewidth}
  \begin{center}
    \includegraphics[width=0.9\linewidth]{./chapters/nuclide_models/mixed_cell/mixed_cell_whole.eps}
  \end{center}
...
\begin{minipage}[b]{0.5\linewidth}
  \begin{center}
    \includegraphics[width=0.9\linewidth]{./chapters/nuclide_models/mixed_cell/mixed_cell_degraded.eps}
  \end{center}

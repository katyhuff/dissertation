...
barrer choices. Thus, in order to distinguish among the performance of fuel cycle, 
geologic media, and \gls{EBS} options, a hydrologic radionuclide contaminant 
transport modeling capability has been included in the repository model. 
Furthermore, modeling capabilities have been implemented at varying levels of 
detail to support varying modeling simplifications and assumptions common in 
performance assessment. Hydrogeologic, geochemical, and mechanical modeling 
behaviors especially important to repository performance were identified by 
sensitivity analyses conducted with a detailed geologic repository performance 
tool. 

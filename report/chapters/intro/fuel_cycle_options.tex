...
and chemical processing decisions upstream in the fuel cycle demand differing 
performance and loading requirements of waste forms and packaging. The 
capability to model thermal and radionuclide transport phenomena through 
vitrified glass as well as ceramic waste forms with with various loadings of 
arbitrary isotopic compositions is therefore required. This work has produced a 
repository model that meets this need. 

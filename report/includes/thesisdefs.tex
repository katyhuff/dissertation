...
\gdef\@committee{
  ...
  Robert C. Witt, Professor, Nuclear Engineering and Engineering Physics\\
  Jean Bahr, Professor, Geoscience\\
  W. Mark Nutt, Nuclear Engineer, Argonne National Laboratory\\
...
%-----------------------------------------------------------------------------
  ...
  \hspace*{-2cm}The dissertation is approved by the following members of the Final Oral Committee:\\
  \@committee
  \end{titlepage}

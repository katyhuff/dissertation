...
\gdef\@defensedate{05/03/2013}
\gdef\@committee{
  \hspace*{1cm}Jean M. Bahr, Professor, Geoscience\\
  \hspace*{1cm}Michael L. Corradini, Professor, Nuclear Engineering and Engineering Physics\\
  \hspace*{1cm}Douglass L. Henderson, Professor, Nuclear Engineering and Engineering Physics\\
  \hspace*{1cm}W. Mark Nutt, Nuclear Engineer, Argonne National Laboratory\\
  \hspace*{1cm}Paul P.H. Wilson, Professor, Nuclear Engineering and Engineering Physics\\
  \hspace*{1cm}Robert J. Witt, Professor, Nuclear Engineering and Engineering Physics\\

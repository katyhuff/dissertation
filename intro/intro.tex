...
order to arrive at a fundamental set of components to model. Four candidate 
geologies and four corresponding repository concepts under consideration by the  
\gls{DOE} \gls{UFD} campaign.
...
consideration will first be undertaken. Potential analytical models to  
...
and geologies can be chosen that covers a foundational subspace of the 
parametric domain. 

...
order to support calculations with hydrologic and material phenomena.  
Waste package dissolution rates, diffusive and advective coefficients,
and the mechanical integrity of engineered barriers and geologic environment 
are coupled with temperature behavior. The time evolution of 
repository heat is such that thermal coupling can likely be neglected 
for long time scales.\cite{andra_argile:_2005} %andra, clay, evaluation, page 195)
...
water flow, and other parameters on a long time scale. 
...
%arrive at.  
However, source term remains a useful metric for the comparison of 
